...
import { OutrunMath, RewardManagerAbstract } from "./RewardManagerAbstract.sol";
...
abstract contract RewardManager is RewardManagerAbstract {
    ...
    function _updateRewardIndex() internal virtual override returns (address[] memory tokens, uint256[] memory indexes) {
